...
//var myColor = [
//    "#fde725", "#eae51a", "#d2e21b", "#bade28", "#a2da37", "#8bd646", "#77d153", "#63cb5f", "#50c46a", "#3fbc73",
//    "#31b57b", "#26ad81", "#21a585", "#1e9d89", "#1f948c", "#228c8d", "#25838e", "#297b8e", "#2c738e", "#2f6b8e",
//    "#33628d", "#38598c", "#3c4f8a", "#404588", "#443b84", "#46307e", "#482576", "#481a6c", "#470d60", "#440154",
//];
//var myColor = [
//    "#fff549", "#fbe95d", "#f4d479", "#ecc18e", "#e6b59b",
//    "#e4b09f", "#e1aba4", "#dfa6a9", "#dba0af", "#d799b5",
//    "#d293bb", "#cc8ac3", "#c682ca", "#be78d3", "#b56ddc",
//    "#aa63e4", "#9d57ef", "#8d4af9",
//];
//var myColor = [
//    "#f0fc49", "#eced61",  "#e4d77c", "#dcc391", "#d7b89c",
//    "#d4b3a0", "#d1aea5",  "#cea9aa", "#cba4ae", "#c79db4",
//    "#c296ba", "#bd8fc0",  "#b686c8", "#af7dcf", "#a573d8",
//    "#9a68e0", "#8d5ee9",  "#7e53f1", "#6847fb",
//];
...
d3.queue()
.defer(d3.csv, "EmployeeRecords.csv")
.defer(d3.csv, "emailheaders.csv")
.await(function(error, nodes, links) {
  ...
  //linksFromTo.length = 900;       // modify this value select subset of the dataset for testing purposes
  //console.log("linksFromTo.length: ", linksFromTo.length);
  ...
  function dynamicNet() {
    ...
    dataSender.forEach(rowList => {
        for (let key in rowList) {
            if (key == "From") {
                ...
                sendersTitle.push(nameEmploymentTitle);
            }
        }
    })
    ...
    sendersTitle = [...new Set([...sendersTitle])];
    sendersTitle.sort();         // sort the array set
    sendersTitle.reverse();      // reverse the array set to align wuth the names ordering in the parallel coordinate

    // display the senders' name in the SVG
    yPosition = 15;
    sendersTitle.forEach((subject, idx, arr) => {
    ...
    yPosition = 15;
    senderEmailSubject.forEach(subject => {
